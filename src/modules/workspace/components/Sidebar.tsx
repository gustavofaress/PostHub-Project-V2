    ...
    <>
          ...
          {NAV_GROUPS.map((group, groupIdx) => (
            <div key={group.label} className="flex w-full flex-col gap-2">
              ...
              {group.items.map((item) => {
                ...
                const ItemIcon = item.id === 'reports' ? TrendingUp : item.icon;
      ...
      {hoveredItem &&
        (() => {
          ...
          const HoverIcon =
            hoveredItem.item.id === 'reports' ? TrendingUp : hoveredItem.item.icon;
          ...
          return (
            ...
            >
              ...
              <div
                className="pointer-events-auto hide-scrollbar w-[280px] animate-in overflow-y-auto rounded-2xl border border-gray-100 bg-white p-5 shadow-[0_8px_30px_rgb(0,0,0,0.12)] fade-in zoom-in-95 duration-200 overscroll-contain"
